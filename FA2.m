...
%currentCharacterEncoding = slCharacterEncoding();
  ...
  Nf = 3;                       % порядок Функціонального аналізу
  ...
  p2=2.75;
  %(4/4)*pi*4;                % верхні межі промужку апроксимації
...
%  C1=E/Y; % поліноміальні коефіцієнти
  C0=E(1,1:end)./Y0; % похибка матриці відсутня через метод обрахування без застосування матриці
  C0(n+2)=0;
